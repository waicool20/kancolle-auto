...
def rejigger_mouse(kc_region, x1, x2, y1, y2, find_position=False):
    ...
    if find_position:
        ...
        global_regions['formation_line_ahead'] = Region(util_settings['game_x'] + 388, util_settings['game_y'] + 160, 119, 50)
        global_regions['formation_double_line'] = Region(util_settings['game_x'] + 519, util_settings['game_y'] + 160, 119, 50)
        global_regions['formation_diamond'] = Region(util_settings['game_x'] + 650, util_settings['game_y'] + 160, 119, 50)
        global_regions['formation_echelon'] = Region(util_settings['game_x'] + 388, util_settings['game_y'] + 319, 119, 50)
        global_regions['formation_line_abreast'] = Region(util_settings['game_x'] + 519, util_settings['game_y'] + 319, 119, 50)
